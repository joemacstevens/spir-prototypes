...
| 4 | **Fasting Tracker** (mini-app revamp — replaces giant ring + 8-wheel pickers) | [AJE-66](https://linear.app/ajeo/issue/AJE-66) | https://fasting-tracker.vercel.app | [SPEC_fasting.md](./fasting-tracker/SPEC_fasting.md) | Backlog (spec authored 2026-05-07; one open question for Jay — confirm the killed manual-end-time XP gate) |
